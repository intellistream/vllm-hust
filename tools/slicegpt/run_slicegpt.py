...
def slicing_arg_parser(interactive: bool = True) -> argparse.Namespace:
    ...
    parser.add_argument("--dtype", type=str, help="Data type to use.", choices=["fp32", "fp16", "bf16"], default="fp16")
    parser.add_argument(
        "--cal-dataset",
        type=str,
    ...
    parser.add_argument("--skip-final-eval", action="store_true", help="Skip final PPL evaluation after saving the sliced model.")
...
def process_slicing_args(args):
    ...
    if args.dtype == "fp16":
        ...
        raise argparse.ArgumentTypeError(f"Data type should be one of 'fp16', 'bf16', 'fp32'")
