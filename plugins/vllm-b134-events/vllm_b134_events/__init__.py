...
Registers :class:`vllm_b134_events.sink.B134TsvSink` on the generic
...
_sink: B134TsvSink | None = None


def register() -> None:
    """Entry point (``vllm.general_plugins``): attach the B134 TSV sink."""
    global _sink
