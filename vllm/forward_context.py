...
class BatchDescriptor:
    ...
    """
    Opaque metadata for an explicitly registered runtime graph key. None for
    statically captured and eager batches.
    """
...
class ForwardContext:
    ...
    """
    Whether the forward pass is executing on a secondary device stream.
    """
    allow_runtime_graph_capture: bool = False
    """
    Whether the backend may capture a runtime-registered graph for this pass.
    """
