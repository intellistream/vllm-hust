...
class Scheduler(SchedulerInterface):
    ...
    def schedule(self, throttle_prefills: bool = False) -> SchedulerOutput:
        ...
        kv_connector_full_block_ids = None
        if self.connector is not None:
            kv_connector_full_block_ids = {
                req_id: self.kv_cache_manager.get_blocks(req_id).get_block_ids(
                    allow_none=True
                )
        ...
        scheduler_output = SchedulerOutput(
            ...
            kv_connector_full_block_ids=kv_connector_full_block_ids,
        )
