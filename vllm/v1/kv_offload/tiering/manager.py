...
class TieringOffloadingManager(OffloadingManager):
    ...
    def __init__(
        ...
        self.lifecycle = SessionLifecycleManager(
            lifecycle_config or LifecycleConfig()
        )
    ...
    def record_request_keys(
        ...
        """Record the block keys associated with a request lifecycle."""
        self.lifecycle.record_request_keys(req_context, keys)
    ...
    def on_new_request(self, req_context: ReqContext) -> RequestOffloadingContext:
        ...
        self.lifecycle.on_new_request(req_context)
        for tier in self.secondary_tiers:
    ...
    def on_request_finished(self, req_context: ReqContext) -> None:
        ...
        self.lifecycle.on_request_finished(req_context)
        state = self._req_state[req_context.req_id]
    ...
    def on_schedule_end(self, context: ScheduleEndContext) -> None:
        ...
        expired = self.lifecycle.expire_idle_sessions(self.secondary_tiers)
        if expired:
    ...
    def has_pending_work(self) -> bool:
        ...
        ) or self.lifecycle.has_pending_expiration()
    ...
    def reset_cache(self) -> None:
        ...
        self.lifecycle.reset_active_primary_state()
