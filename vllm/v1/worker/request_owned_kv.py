...
speculative verification uses separate physical-reservation and
logical-commit watermarks so rejected tails never become durable.  The store
keeps no local epoch fence: physical records are keyed by the full
